...
class Portfolio extends React.Component {
  componentDidMount() {
    ...
    window.$.fn.bxSlider = function (options) {
      if (this.length === 0) {
        return this;
      }
      ...
      var slider = {},
        ...
        windowHeight = window.$(window).height();

      // Return if slider is already initialized
      if (window.$(el).data("bxSlider")) {
        return;
      }
      ...
      var init = function () {
        ...
        slider.settings = window.$.extend({}, defaults, options);
        ...
        el.children(slider.settings.slideSelector).each(function () {
          window.$(this).data("origStyle", window.$(this).attr("style"));
        });
      ...
      var setup = function () {
        ...
        slider.loader = window.$('<div class="bx-loading" />');
        ...
        slider.controls.el = window.$('<div class="bx-controls" />');
      ...
      var start = function () {
        ...
        if (slider.settings.responsive) {
          window.$(window).bind("resize", resizeWindow);
        }
        ...
        if (slider.settings.keyboardEnabled && !slider.settings.ticker) {
          window.$(document).keydown(keyPress);
        }
      };
      ...
      var getViewportHeight = function () {
        ...
        if (slider.settings.mode === "vertical") {
          children.each(function (index) {
            height += window.$(this).outerHeight();
          });
          ...
          height = Math.max.apply(
            ...
            children
              .map(function () {
                return window.$(this).outerHeight(false);
              })
              .get()
          );
        }
        ...
        for (var i = 0; i < pagerQty; i++) {
          ...
          if (
            (slider.settings.buildPager &&
              window.$.isFunction(slider.settings.buildPager)) ||
          ...
          // var linkContent = slider.settings.buildPager && window.$.isFunction(slider.settings.buildPager) ? slider.settings.buildPager(i) : i + 1;
      ...
      var appendPager = function () {
        if (!slider.settings.pagerCustom) {
          ...
          slider.pagerEl = window.$('<div class="bx-pager" />');
          // if a pager selector was supplied, populate it with the pager
          if (slider.settings.pagerSelector) {
            window.$(slider.settings.pagerSelector).html(slider.pagerEl);
          ...
          slider.pagerEl = window.$(slider.settings.pagerCustom);
        }
      ...
      var appendControls = function () {
        slider.controls.next = window.$(
          '<a class="bx-next" href="">' + slider.settings.nextText + "</a>"
        );
        slider.controls.prev = window.$(
        ...
        if (slider.settings.nextSelector) {
          window.$(slider.settings.nextSelector).append(slider.controls.next);
        }
        // if prevSelector was supplied, populate it
        if (slider.settings.prevSelector) {
          window.$(slider.settings.prevSelector).append(slider.controls.prev);
        }
        // if no custom selectors were supplied
        if (!slider.settings.nextSelector && !slider.settings.prevSelector) {
          // add the controls to the DOM
          slider.controls.directionEl = window.$(
      ...
      var appendControlsAuto = function () {
        slider.controls.start = window.$(
          '<div class="bx-controls-auto-item"><a class="bx-start" href="">' +
            slider.settings.startText +
            "</a></div>"
        );
        slider.controls.stop = window.$(
          '<div class="bx-controls-auto-item"><a class="bx-stop" href="">' +
            slider.settings.stopText +
            "</a></div>"
        );
        // add the controls to the DOM
        slider.controls.autoEl = window.$('<div class="bx-controls-auto" />');
        // bind click actions to the controls
      ...
      var appendCaptions = function () {
        ...
        slider.children.each(function (index) {
          ...
          var title = window.$(this).find("img:first").attr("title");
          // append the caption
      ...
      var clickPagerBind = function (e) {
        ...
        pagerLink = window.$(e.currentTarget);
      ...
      var updatePagerActive = function (slideIndex) {
        ...
        slider.pagerEl.each(function (i, el) {
          window.$(el).find("a").eq(slideIndex).addClass("active");
        });
      };
            ...
            slider.viewport.hover(
              ...
              function () {
                ...
                slider.children.each(function (index) {
                  totalDimens +=
                    slider.settings.mode === "horizontal"
                      ? window.$(this).outerWidth(true)
                      : window.$(this).outerHeight(true);
                });
      ...
      var resizeWindow = function (e) {
        ...
        if (slider.working) {
          ...
          var windowWidthNew = window.$(window).width(),
            windowHeightNew = window.$(window).height();
        ...
        if (slider.settings.mode === "fade") {
          ...
          slider.children
            ...
            .fadeIn(slider.settings.speed, function () {
              window.$(this).css("zIndex", slider.settings.slideZIndex);
              updateAfterSlideTransition();
            });
      ...
      el.destroySlider = function () {
        ...
        window.$(".bx-clone", this).remove();
        slider.children.each(function () {
          if (window.$(this).data("origStyle") !== undefined) {
            window.$(this).attr("style", window.$(this).data("origStyle"));
          } else {
            window.$(this).removeAttr("style");
          }
        });
        if (window.$(this).data("origStyle") !== undefined) {
          this.attr("style", window.$(this).data("origStyle"));
        } else {
          window.$(this).removeAttr("style");
        }
        window.$(this).unwrap().unwrap();
        ...
        window.$(".bx-caption", this).remove();
        if (slider.controls.autoEl) {
          slider.controls.autoEl.remove();
        }
        clearInterval(slider.interval);
        if (slider.settings.responsive) {
          window.$(window).unbind("resize", resizeWindow);
        }
        if (slider.settings.keyboardEnabled) {
          window.$(document).unbind("keydown", keyPress);
        }
        //remove self reference in data
        window.$(this).removeData("bxSlider");
      };
    ...
    return (
      <>
        ...
        <div className="works">
          <div className="work">
            <div className="slider">
              <img className="img" src={work1_1}></img>
              <img className="img" src={work1_2}></img>
              <img className="img" src={work1_3}></img>
              <img className="img" src={work1_4}></img>
            </div>
            <p>
              작업명 : 스마트공장 관리 시스템 (참여)
              <br />
          ...
          <div className="work">
            <div className="slider">
              <img className="img" src={work2_1}></img>
              <img className="img" src={work2_2}></img>
              <img className="img" src={work2_3}></img>
              <img className="img" src={work2_4}></img>
            </div>
            <p>
              작업명 : 개인 홈페이지(단독)
              <br />
          ...
          <div className="work_app">
            <div className="slider">
              <img className="img_app" src={work3_1}></img>
              <img className="img_app" src={work3_2}></img>
              <img className="img_app" src={work3_3}></img>
              <img className="img_app" src={work3_4}></img>
              <img className="img_app" src={work3_5}></img>
            </div>
            <p>
              작업명 : 프로젝트 일정관리 앱(단독)
              <br />
          ...
          <div className="work_app">
            <div className="slider">
              <img className="img_app" src={work4_1}></img>
              <img className="img_app" src={work4_2}></img>
              <img className="img_app" src={work4_3}></img>
            </div>
            <p>
